...
export type Char = Array<Byte> // 8 bytes
export type PixelColor = Array<Byte> // TODO: make r, g, b
export type CharSet = Array<Char>
export type Tile = Array<Array<PixelColor>> // 8 x 8 pixels

export type SharpImage = { data: Buffer; info: OutputInfo }
